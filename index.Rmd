...
- **Initiation of Movement:** Ali Can announces #MeTwo to attract attention to problems of dicrimination and latent racism towards German with migration background

- **#MeTwo emerges:** More than 150,000 tweets in about one week (July 24 - August 03 2018)

- **Data Science Perspective:** Analyse contributor, networks and content of this movement to identify underlying pattern
]
...
- **#MeTwo:** Important social media movement with impact to the offline world, sparking discussion on the definition of *Germanhood*

- **Insights:** MeTwo was successful because influencer and social activists took part in event

- **Insights:** Although negative experiences have been made, lots of people spread positivity

- **Blog-Post:** [*https://metwo.correlaid.org/*](https://metwo.correlaid.org/)
